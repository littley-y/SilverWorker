...
**Reviewer**: Gemini
**Date**: 2026-04-25
**Target Files**: `General/.github/workflows/pages.yml`, `General/wiki.html`, `docs/AGENTS.md` 등
...
### ✅ 2.1 `AGENTS.md` (반영 완료)
- `docs/AGENTS.md` 파일이 존재하며, `pages.yml`의 `cp AGENTS.md _site/` 명령어로 정상 복사됩니다.
...
- 부모 폴더에 있는 `REVIEWER_PROMPT.md`를 `General/` 내부로 이동시키세요. (예: `docs/planning/REVIEWER_PROMPT.md` 또는 `docs/AGENTS.md`와 동일 레벨)
