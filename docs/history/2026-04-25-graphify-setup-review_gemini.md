...
**Reviewer**: Gemini
**Date**: 2026-04-25
**Target Document**: `docs/history/2026-04-25-graphify-setup.md`
...
- **해결 방안**: 프로젝트 클론 시 에이전트 환경을 구성해주는 공통 초기화 스크립트(예: `init_agents.sh`)를 작성하고, `docs/README.md` 등에 **"클론 후 반드시 `graphify <agent> install` 또는 초기화 스크립트를 실행하라"**는 온보딩 가이드를 명시해야 합니다.
