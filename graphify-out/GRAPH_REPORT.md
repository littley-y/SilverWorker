...
## Corpus Check
- 76 files · ~95,477 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 431 nodes · 564 edges · 22 communities detected
...
Cohesion: 0.07
Nodes (30): BookmarkRepository, main, main, JobModel, _jobWithIntensity, main, main, _MockRepository (+22 more)
...
Cohesion: 0.08
Nodes (22): AuthRepository, Function, _mapAuthError, AlreadyAppliedException, ApplicationRepository, JobClosedException, JobNotFoundException, AuthRepository (+14 more)

### Community 5 - "Community 5"
Cohesion: 0.08
Nodes (24): ../helpers/test_doubles.dart, main, main, _ErrorApplicationRepository, Exception, main, _MockApplicationRepository, _MockAuthRepository (+16 more)
...
## Knowledge Gaps
- **277 isolated node(s):** `Claude Code SessionStart / SubagentStart hook - injects General folder context.`, `Return the most recent .md that isn't an empty session-summary.`, `Claude Code PreToolUse hook - guards git write operations.  Rules:   1. git push`, `working_dir가 프로젝트 루트인지 확인.`, `git push origin master/main 형태의 직접 푸시 감지.` (+272 more)
...
- **Why does `package:flutter/material.dart` connect `Community 1` to `Community 0`, `Community 2`, `Community 3`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`?**
  _High betweenness centrality (0.208) - this node is a cross-community bridge._
- **Why does `package:flutter_riverpod/flutter_riverpod.dart` connect `Community 2` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 8`, `Community 9`, `Community 10`, `Community 11`?**
  _High betweenness centrality (0.145) - this node is a cross-community bridge._
- **Why does `package:flutter_test/flutter_test.dart` connect `Community 2` to `Community 4`, `Community 5`?**
