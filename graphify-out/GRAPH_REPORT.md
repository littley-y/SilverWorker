...
## Corpus Check
- 70 files · ~84,972 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 384 nodes · 486 edges · 21 communities detected
...
Cohesion: 0.05
Nodes (33): app_colors.dart, BadgeWidget, build, Container, build, LoadingOverlay, Stack, main (+25 more)

### Community 1 - "Community 1"
Cohesion: 0.07
Nodes (27): ApplicationRepository, BookmarkRepository, ApplicationFormScreen, _ApplicationFormScreenState, build, Center, Column, dispose (+19 more)

### Community 2 - "Community 2"
Cohesion: 0.07
Nodes (28): ../constants/app_colors.dart, ../constants/app_text_styles.dart, build, _ChipRow, Column, FilterBar, _FilterChip, _FilterOption (+20 more)
...
Cohesion: 0.08
Nodes (24): ApplicationResultScreen, build, Center, Icon, Scaffold, SizedBox, Text, build (+16 more)

### Community 5 - "Community 5"
Cohesion: 0.1
Nodes (23): ../helpers/test_doubles.dart, main, _MockRepository, _sampleJob, _ErrorApplicationRepository, Exception, main, _MockApplicationRepository (+15 more)
...
Cohesion: 0.1
Nodes (16): AuthRepository, Function, _mapAuthError, AlreadyAppliedException, ApplicationRepository, JobClosedException, JobNotFoundException, AuthRepository (+8 more)
...
- **Thin community `Community 18`** (4 nodes): `handle_new_rx_page()`, `__lldb_init_module()`, `Intercept NOTIFY_DEBUGGER_ABOUT_RX_PAGES and touch the pages.`, `flutter_lldb_helper.py`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
- **Thin community `Community 19`** (3 nodes): `hook_agent_notify.py`, `main()`, `Claude Code PostToolUse hook - Discord notification on agent completion. Called`
  Too small to be a meaningful cluster - may be noise or needs more connections extracted.
...
- **Why does `package:flutter/material.dart` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 9`, `Community 10`, `Community 13`?**
  _High betweenness centrality (0.247) - this node is a cross-community bridge._
- **Why does `package:flutter_riverpod/flutter_riverpod.dart` connect `Community 1` to `Community 0`, `Community 3`, `Community 4`, `Community 5`, `Community 6`, `Community 7`, `Community 8`, `Community 9`, `Community 10`, `Community 13`?**
  _High betweenness centrality (0.166) - this node is a cross-community bridge._
- **Why does `../constants/app_colors.dart` connect `Community 2` to `Community 1`, `Community 3`, `Community 4`, `Community 6`, `Community 9`, `Community 10`?**
