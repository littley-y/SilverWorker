...
## Corpus Check
- 75 files · ~97,055 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 433 nodes · 568 edges · 21 communities detected
...
Cohesion: 0.04
Nodes (48): app_colors.dart, ../constants/app_colors.dart, ../constants/app_text_styles.dart, color, icon, IntensityHelper, label, showErrorSnack (+40 more)
...
Cohesion: 0.06
Nodes (35): ../helpers/test_doubles.dart, AuthRepository, Function, _mapAuthError, AuthRepository, Function, MockUser, main (+27 more)

### Community 3 - "Community 3"
Cohesion: 0.06
Nodes (29): main, main, main, JobModel, _jobWithIntensity, main, main, _MockRepository (+21 more)

### Community 4 - "Community 4"
Cohesion: 0.06
Nodes (31): firebase_options.dart, build, main, MyApp, ApplicationRepository, ApplicationFormScreen, _ApplicationFormScreenState, build (+23 more)
...
Cohesion: 0.11
Nodes (16): AlreadyAppliedException, ApplicationRepository, JobClosedException, JobNotFoundException, ApplicationCard, ApplicationListScreen, build, Center (+8 more)
...
## Knowledge Gaps
- **281 isolated node(s):** `Claude Code SessionStart / SubagentStart hook - injects General folder context.`, `Return the most recent .md that isn't an empty session-summary.`, `Claude Code PreToolUse hook - guards git write operations.  Rules:   1. git push`, `working_dir가 프로젝트 루트인지 확인.`, `git push origin master/main 형태의 직접 푸시 감지.` (+276 more)
...
- **Why does `package:flutter/material.dart` connect `Community 0` to `Community 1`, `Community 2`, `Community 3`, `Community 4`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`?**
  _High betweenness centrality (0.229) - this node is a cross-community bridge._
- **Why does `package:flutter_riverpod/flutter_riverpod.dart` connect `Community 4` to `Community 1`, `Community 2`, `Community 3`, `Community 5`, `Community 7`, `Community 8`, `Community 9`, `Community 10`?**
  _High betweenness centrality (0.128) - this node is a cross-community bridge._
- **Why does `package:flutter_test/flutter_test.dart` connect `Community 3` to `Community 0`, `Community 2`?**
