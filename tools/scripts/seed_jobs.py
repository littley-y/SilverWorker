...
COMPANY_NAMES: dict[str, list[str]] = {
    "security_management": [
        "종로더샵아파트", "강남자이아파트", "롯데캐슬아파트",
        "삼성래미안아파트", "현대아이파크아파트", "두산위브아파트",
        "대림e편한세상아파트", "힐스테이트아파트", "자이아파트",
        "포레나아파트", "더샵아파트", "래미안아파트",
    ],
    "cleaning": [
        "서울아산병원", "삼성서울병원", "세브란스병원",
        "서울대병원", "고려대병원", "연세세브란스병원",
        "삼성래미안아파트", "현대아이파크아파트", "두산위브아파트",
        "자이아파트", "힐스테이트아파트", "e편한세상아파트",
    ],
    "simple_labor": [
        "쿠팡물류센터", "마켓컬리물류센터", "SSG닷컴물류센터",
        "이마트물류센터", "롯데마트물류센터", "홈플러스물류센터",
        "CJ대한통운물류센터", "로젠택배물류센터", "한진택배물류센터",
        "우체국택배물류센터", "쿠팡로켓배송센터", "마켓컬리새벽배송센터",
    ],
    "service": [
        "GS25편의점", "CU편의점", "7-ELEVEN편의점",
        "미니스톱편의점", "이마트24편의점", "롯데리아매장",
        "맥도날드매장", "버거킹매장", "KFC매장",
        "스타벅스매장", "투썸플레이스매장", "이디야커피매장",
    ],
    "office_work": [
        "삼성전자사무실", "LG전자사무실", "현대자동차사무실",
        "SK하이닉스사무실", "POSCO사무실", "KT사무실",
        "LG유플러스사무실", "SK텔레콤사무실", "한국전력사무실",
        "한화그룹사무실", "롯데그룹사무실", "신한은행사무실",
    ],
}
